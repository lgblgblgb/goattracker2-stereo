...
;                                      X = channel index 0,7,14,21,28,35)
;
...
playsound:      sec
                ...
                ldy sfxtblhi,x
playchannel:    ldx #$0e                        ;Channel index in X
                jsr $1006                       ;(0,7,14,21,28,35)
                lda playchannel+1
                clc                             ;Switch SID for next sound
                adc #21
                cmp #42
                bcc playchannelok
                sbc #42
playchannelok:  sta playchannel+1
                jmp idle
